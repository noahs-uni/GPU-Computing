...
1MB, where with data larger than 1MB the threads have to deal with slower and multiple accesses to main memory. This is shown in figure \ref{fig:2.2a}.

\begin{figure}
    \centering
    \includegraphics[scale=0.7]{pictures/coalesced_thread_access_a.png}
    \caption{exercise 3.2: 1 threadblock, different numbers of threads}
    \label{fig:2.2a}
\end{figure}
...
threadblocks (32). This is shown in figure \ref{fig:2.2b}.

\begin{figure}
    \centering
    \includegraphics[scale=0.7]{pictures/coalesced_thread_access_b.png}
    \caption{exercise 3.2: 1024 threads, different numbers of blocks}
    \label{fig:2.2b}
\end{figure}
=======
